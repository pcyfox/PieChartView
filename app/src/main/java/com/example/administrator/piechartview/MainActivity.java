...
public class MainActivity extends Activity {
    private AllStuAnswerStatisticalGraphDialog dialog;
...
//        pieChartView.addItemType(new PieChartView.ItemType("苹果", 0, 0xff20B2AA));
...
//        pieChartView.setTextPadding(10);
        ...
        dialog = new AllStuAnswerStatisticalGraphDialog();
